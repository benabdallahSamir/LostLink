...
public class ResetConfirm extends JDialog {
	...
	public ResetConfirm(Main main) {
		...
		JLabel titleLabel = new JLabel("Reset Form?");
		...
		txtpnAreYouSure.setText("Are you sure you want to clear all inputs? This action cannot be undone.");
		txtpnAreYouSure.setBounds(10, 37, 315, 41);
